...
for key in unique_keys:
    ...
    for _, row in rows.iterrows():
        ...
        gov_id = str(int(row["governor_id"]))

        if gov_id in gov_old_ids:
            existing_ids.append(
                gov_old_ids[gov_id]
            )
...
proclamation["event_id"] = proclamation["disaster_id"].map(gov_map)

### Reuse Governor event IDs from previous runs
old_gov_map = {
    int(source_id): event_id
    for source_id, event_id in gov_old_ids.items()
}

proclamation["event_id"] = (
    proclamation["disaster_id"]
    .map(old_gov_map)
    .fillna(proclamation["event_id"])
)
...
print("\nUnique event IDs:")
print("Governor:", proclamation["event_id"].nunique())

print("SBA:", sba_tx["event_id"].nunique())
print("FEMA:", fema["event_id"].nunique())
...
print("\nTotal unique event IDs across all sources:")
print(all_event_ids["event_id"].nunique())
...
gov_registry = (
    proclamation[["disaster_id", "event_id"]]
    .drop_duplicates()
    .rename(columns={"disaster_id": "source_id"})
)
...
##----------inspect one suspicious ID
print("\nRecords using EID_0015:")

print(
    event_registry[
        event_registry["event_id"] == "EID_0015"
    ]
)

# ##need to see whether those three are actually the same disaster or whether this is an accidental ID

# print("\nGovernor 1:")
# print(
#     proclamation[
#         proclamation["disaster_id"] == 1
#     ][
#         ["disaster_id", "publication_date", "disaster_type", "title"]
#     ].drop_duplicates()
# )
...
# print(
#     sba_tx[
#         sba_tx["disaster_number"] == "TX-20083"
#     ][
#         ["disaster_number", "incident_start_date", "disaster_description"]
#     ].drop_duplicates()
# )
...
# print(
#     fema[
#         fema["disasterNumber"] == 5675
#     ][
#         ["disasterNumber", "incidentBeginDate", "incidentType", "declarationTitle"]
#     ].drop_duplicates()
# )
